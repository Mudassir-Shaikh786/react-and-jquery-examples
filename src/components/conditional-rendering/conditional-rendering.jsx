    ...
    return(
        <div className="container-fluid">
            <nav className="d-flex justify-content-between p-2 mt-3">
                ...
                <div>
                    {
                        (signedIn===true)?<button onClick={handleSignout} className="btn btn-danger">Signout</button>:
            ...
            <section className="mt-4">
                ...
                <DataGrid layout={layout} fields={["Name", "Price","Stock"]} data={[{Name:"Samsung TV", Price:45000.44, Stock:"True"},{Name:"Mobile", Price:13000.44, Stock:"False"},{Name:"Washing Machine", Price:40000.54, Stock:"True"},{Name:"Smart Watch", Price:22000.56, Stock:"True"}]} />
            </section>
        </div>
    )
}